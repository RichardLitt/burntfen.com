...
function ImageFlow ()
{
	...
	this.defaults =
	{
		...
		imageFocusM:        150,            /* Multiplicator for the focussed image size in percent */
		...
		onClick:            function() {myPopup(this.url, this.caption, this.preview_img); }   /* Onclick behaviour */
	};

	function myPopup(url, caption, preview_img) {
		var s1 = new SWFObject("player.swf","ply","640","500","9","#FFFFFF");
		s1.addParam("allowfullscreen","true");
		s1.addParam("allowscriptaccess","always");
		s1.addParam("flashvars","file=" + url + "&image=" + preview_img);
		s1.write("container");
	...
	this.refresh = function()
	{
		...
		{ 
			...
			if(image !== null && image.nodeType == 1 && image.nodeName == 'IMG')
			{
				...
				/* deans mod */
				image.caption = image.getAttribute('alt');
				image.preview_img = image.getAttribute('preview');
